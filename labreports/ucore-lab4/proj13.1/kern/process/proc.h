...
struct proc_struct {
    ...
    int time_slice;                             // time slice for occupying the CPU
 	skew_heap_entry_t lab4_run_pool;            // FOR LAB4 ONLY: the entry in the run pool
	uint32_t lab4_stride;                       // For LAB4 ONLY: the current stride of the process 
	uint32_t lab4_priority;                     // For LAB4 ONLY: the priority of process, set by lab4_set_priority(uint32_t)
};
...
void lab4_set_priority(uint32_t priority);
