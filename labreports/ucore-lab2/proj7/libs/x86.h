...
static inline void lcr0(uint32_t val) __attribute__((always_inline));
static inline void lcr3(uint32_t val) __attribute__((always_inline));
static inline uint32_t rcr0(void) __attribute__((always_inline));
static inline uint32_t rcr1(void) __attribute__((always_inline));
static inline uint32_t rcr2(void) __attribute__((always_inline));
static inline uint32_t rcr3(void) __attribute__((always_inline));
