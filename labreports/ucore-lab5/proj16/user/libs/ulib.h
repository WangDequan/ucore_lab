...
cdt_t cdt_init();
int cdt_signal(cdt_t cdt_id);
int cdt_wait(cdt_t cdt_id ,klock_t klock_id);
int cdt_free(cdt_t cdt_id);
klock_t klock_init();
int klock_aquire(klock_t klock_id);
int klock_release(klock_t klock_id);
int klock_free(klock_t klock_id);
