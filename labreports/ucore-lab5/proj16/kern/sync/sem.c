...
/*
 * Function __up is the basic function implementing semophore signal operation. You should 
 * decide whether to modify the value of the semophore or not and wakeup the first process
 * that is blocked by semophore wait operation and delete from the waitqueue.
 *
 * You may get help in  /kern/sync/wait.c
 *
 */
...
/*
 * Function __down is the basic function implementing semophore wait operation. You should 
 * decide whether to modify the value of the semophore or not. Processes than should be  
 * blocked must be ensured sleeping and put into the waitqueue. A timer is added to avoid
 * the unbounded waiting exceeding the given threshold.
 *
 * You may get help in  /kern/sync/wait.c
 *
 */
