...
-----------------------------------------
Software design:
  First, we design mm & vma struct to build a set of continuing virtual memory area (vma), mm struct is 
used to manage the the vma set which has the same PDT. Each vma struct descripts a  continuing virtual memory area.
--------------------------
